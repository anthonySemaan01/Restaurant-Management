...
ALTER TABLE `Manager` ADD FOREIGN KEY (`restaurant_id`) REFERENCES `Restaurant` (`restaurant_id`);

ALTER TABLE `Staff` ADD FOREIGN KEY (`manager_id`) REFERENCES `Manager` (`manager_id`);

ALTER TABLE `Staff` ADD FOREIGN KEY (`restaurant_id`) REFERENCES `Restaurant` (`restaurant_id`);

ALTER TABLE `Order` ADD FOREIGN KEY (`table_id`) REFERENCES `Table` (`table_id`);

ALTER TABLE `Order` ADD FOREIGN KEY (`id_init`) REFERENCES `Staff` (`staff_id`);

ALTER TABLE `Order` ADD FOREIGN KEY (`id_fin`) REFERENCES `Staff` (`staff_id`);
...
ALTER TABLE `Reservation` ADD FOREIGN KEY (`id_proc`) REFERENCES `Staff` (`staff_id`);

ALTER TABLE `Table` ADD FOREIGN KEY (`restaurant_id`) REFERENCES `Restaurant` (`restaurant_id`);

ALTER TABLE `Restaurant` ADD FOREIGN KEY (`manager_id`) REFERENCES `Manager` (`manager_id`);
...
ALTER TABLE `OrderDish` ADD FOREIGN KEY (`order_id`) REFERENCES `Order` (`order_id`);

ALTER TABLE `OrderDish` ADD FOREIGN KEY (`dish_id`) REFERENCES `Dish` (`dish_id`);
